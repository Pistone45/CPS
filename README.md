# CLAIMS PROSESSING SYSTEM
A SYSTEM FOR PROCESSING CLAIMS
...
# INTRODUCTION
This system will help customers get claims from a company
...
* Pull the entire project from (https://github.com/Pistone45/cps) to the desired directory.
* #### Using The Command Line:

__Via Git__
- Clone to your machine
```
git clone https://github.com/Pistone45/cps.git
```
